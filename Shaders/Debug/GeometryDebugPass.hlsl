...
// Relies on the shader's HLSLINCLUDE providing the surface / toon-lighting interfaces
// (SurfaceInterface, ToonLightingInterface) plus the RegionID + ToonLighting math libraries.
